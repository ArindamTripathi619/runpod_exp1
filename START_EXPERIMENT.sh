#!/bin/bash
#############################################################################
# START_EXPERIMENT.sh - Experiment 1 Setup and Execution
# This script sets up the environment and runs Experiment 1 automatically
#############################################################################

set -e  # Exit on any error

echo "=========================================="
echo "🚀 Starting Experiment 1 Setup"
echo "=========================================="
echo ""
...
export DB_PATH="${DB_PATH:-exp1_results.db}"
export LOG_FILE="${LOG_FILE:-exp1_execution.log}"
export OUTPUT_DIR="${OUTPUT_DIR:-exp1_results}"

echo "=========================================="
echo "⚙️  Experiment 1 Configuration"
echo "=========================================="
echo "Trials:          $TRIALS"
...
echo "=========================================="
echo ""
echo "This will run experiment 1 with $TRIALS trials..."
